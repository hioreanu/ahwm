...
char *default_ahwmrc[] = {
"# FIXME:",
"# if an '=' and an 'is!' both apply for the same option, the second",
"# one found is used, not the 'is!'",
"",
...
"",
"# QUICK REFERENCE",
"# these can also be found in the man pages",
"#",
"# Selectors:",
"#",
...
"# AltTab (void)                    - please see example above",
...
"# Beep (void)                      - ring your bell",
"# Focus (void)                     - focus window clicked on",
"# Invoke (string)                  - please see example",
"# ShowMenu (void)                  - not implemented",
"# Refresh (void)                   - not implemented",
};
#define DEFAULT_AHWMRC_NLINES 381
